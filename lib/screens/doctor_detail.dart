    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Dr. Khanyile is a specialist in internal medicine & a Paediatrician ',
            style: TextStyle(
    ...
    return SizedBox(
      ...
      child: ClipRRect(
        ...
        child: FlutterMap(
          ...
          layers: [
            TileLayerOptions(
              urlTemplate:'https://images.app.goo.gl/BvsNSJbzNnVNWeyb9',
              subdomains: ['a', 'b', 'c'],
            ),
          ],
        ),
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Image(
                image: AssetImage('assets/doctor07.jpg'),
                width: 100,
              )
            ],
          ),
